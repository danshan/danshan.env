...
bootstrap_preflight() {
    ...
    for file in Brewfile config/mise-system.toml config/mise-policy.tsv config/bootstrap.env config/dotfiles.tsv config/repositories.tsv config/links.tsv config/migrations.txt \
