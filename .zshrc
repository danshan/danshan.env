...
export ZSH=/Users/shanhonghao/.oh-my-zsh
...
ZSH_CUSTOM='/Users/shanhonghao/Dropbox/sync/mac/.oh-my-zshrc'
...
export PATH="$PATH:/Users/shanhonghao/.bin"
export PATH="$PATH:/Users/shanhonghao/.local/bin"
...
# Add JAVA_HOME
export JAVA_HOME="/Users/shanhonghao/.sdkman/candidates/java/current"
...
export SDKMAN_DIR="/Users/shanhonghao/.sdkman"
[[ -s "/Users/shanhonghao/.sdkman/bin/sdkman-init.sh" ]] && source "/Users/shanhonghao/.sdkman/bin/sdkman-init.sh"
...
__conda_setup="$('/Users/shanhonghao/workspace/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/shanhonghao/workspace/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/shanhonghao/workspace/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/shanhonghao/workspace/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
