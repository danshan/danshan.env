...
| `adr/` | 当前有效的架构与信任决策, 已删除编号不复用 | [ADR 0007](adr/0007-reviewed-npm-trust-policy-exception.md), [ADR 0008](adr/0008-native-package-managers-and-explicit-migrations.md), [ADR 0009](adr/0009-playwright-cli-trust-hold.md) |
