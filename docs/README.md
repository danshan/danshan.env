...
| `adr/` | 当前有效的架构与信任决策, 已删除编号不复用 | [ADR 0007](adr/0007-reviewed-npm-trust-policy-exception.md), [ADR 0008](adr/0008-native-package-managers-and-explicit-migrations.md), [ADR 0009](adr/0009-playwright-cli-trust-hold.md), [ADR 0010](adr/0010-local-compatibility-casks.md), [ADR 0011](adr/0011-perl-flock-helper.md), [ADR 0012](adr/0012-fish-default-login-shell.md), [ADR 0013](adr/0013-per-package-update-policies.md), [ADR 0014](adr/0014-thaw-platform-upper-bound.md) |
